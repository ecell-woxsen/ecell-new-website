...
const testCases = [
  ...
  { name: "E-Cell Logo v2 (Resized)", url: getAssetUrl("/ecell-logo-v2.webp") },
  { name: "Ambient Video Loop", url: getAssetUrl("/still_shot.mp4") },
  { name: "Events Pack v2 (Resized)", url: getAssetUrl("/ecell_packs/events_pack_v2.bin") },
  { name: "Team Pack v2 (Resized)", url: getAssetUrl("/ecell_packs/team_pack_v2.bin") },
