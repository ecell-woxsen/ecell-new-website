      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
        ...
        <div className="space-y-3">
          <a
            ...
            className="flex items-start gap-3 p-3 rounded-2xl bg-slate-950/60 border border-white/10 hover:border-[#ee495c]/40 hover:bg-[#ee495c]/5 transition-colors group"
          >
            <div className="w-8 h-8 rounded-xl bg-[#ee495c]/15 border border-[#ee495c]/30 flex items-center justify-center text-[#ee495c] shrink-0 mt-0.5">
              <Mail className="w-4 h-4" />
            </div>
            <div>
              <span className="text-[10px] font-mono text-slate-400 uppercase">Email Us</span>
              <p className="text-xs sm:text-sm font-semibold text-white group-hover:text-[#ff7686] transition-colors">
                ecell@woxsen.edu.in
              </p>
            </div>
          </a>
          ...
          <div className="flex items-start gap-3 p-3 rounded-2xl bg-slate-950/60 border border-white/10 hover:border-[#ee495c]/40 hover:bg-[#ee495c]/5 transition-colors group">
            <div className="w-8 h-8 rounded-xl bg-[#ee495c]/15 border border-[#ee495c]/30 flex items-center justify-center text-[#ee495c] shrink-0 mt-0.5">
              <MapPin className="w-4 h-4" />
            </div>
            <div>
              <span className="text-[10px] font-mono text-slate-400 uppercase">Campus Location</span>
              <p className="text-xs text-white font-medium group-hover:text-[#ff7686] transition-colors">
        ...
        <div className="p-4 rounded-2xl bg-slate-950/70 border border-white/10 flex flex-col justify-between">
          {sent ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-4">
              <CheckCircle2 className="w-10 h-10 text-[#ee495c] mb-2" />
            ...
            <form onSubmit={handleSend} className="space-y-2.5 text-xs">
              <div>
                <input
                  ...
                  className="w-full bg-slate-900/80 border border-white/10 rounded-xl px-3 py-2 text-white placeholder-slate-500 focus:outline-none focus:border-[#ee495c]/60"
                />
              </div>
              <div>
                <input
              ...
              <div>
                <textarea
                  ...
                  className="w-full bg-slate-900/80 border border-white/10 rounded-xl px-3 py-2 text-white placeholder-slate-500 focus:outline-none focus:border-[#ee495c]/60 resize-none"
                />
              </div>
              <button
                type="submit"
                className="w-full py-2 rounded-xl bg-[#ee495c] hover:bg-[#ff5a6e] text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-lg shadow-[#ee495c]/25 transition-all cursor-pointer"
              >
      ...
      <div className="pt-3 border-t border-white/10 flex flex-wrap items-center justify-between gap-3 text-xs">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-white/5 hover:bg-[#ee495c]/10 border border-transparent hover:border-[#ee495c]/30 text-slate-300 hover:text-white transition-all group"
          >
            <svg className="w-3.5 h-3.5 fill-white group-hover:fill-[#ee495c] transition-colors" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-white/5 hover:bg-[#ee495c]/10 border border-transparent hover:border-[#ee495c]/30 text-slate-300 hover:text-white transition-all group"
          >
            <Globe className="w-3.5 h-3.5 text-[#ee495c]" />
